...
const CanteenAndComplaints = () => {
  const sections = [
    {
      title: "Complaint Box",
      images: ["https://i.ibb.co/prwCZTJ2/213.jpg"],
    },
    {
      title: "Canteen",
      images: [
        "https://i.ibb.co/LX9FY7Px/1029.jpg",
        "https://i.ibb.co/JjD17wbs/129.jpg",
      ],
    },
  ];
  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://i.ibb.co/LX9FY7Px/1029.jpg')",
        }}
      >
            ...
            <div className="flex items-center justify-between mb-4 text-white">
              <div className="text-sm md:text-base">
                ...
                <span className="opacity-80">
                  ({activeImageIdx + 1}/{currentImages.length || 1})
                </span>
              </div>
              <button
